    ...
    <div className="min-h-screen bg-[#F8FAFC] pb-24">
      ...
      <div className="sticky top-0 bg-white/80 backdrop-blur-xl border-b border-slate-100 p-4 flex items-center gap-4 z-20 shadow-sm">
        ...
        <div>
          ...
          <p className="text-[10px] text-blue-500 font-black uppercase tracking-[0.15em]">Via Excel</p>
        </div>
      </div>
        ...
        <div className="border-none rounded-[2rem] sm:rounded-[2.5rem] bg-white shadow-xl text-center overflow-hidden p-6 sm:p-10">
          ...
          <form onSubmit={handleImportSubmit} className="space-y-6 text-left">
            ...
            <div className="space-y-2">
              ...
              <select className="w-full h-12 px-5 rounded-2xl bg-slate-50 border-none text-sm font-bold text-slate-700 outline-none focus:ring-2 focus:ring-blue-400 appearance-none shadow-inner" value={importType} onChange={(e) => setImportType(e.target.value)}>
            ...
            <div className="bg-blue-50/50 rounded-2xl sm:rounded-3xl p-4 sm:p-6 mb-6 sm:mb-8 border border-blue-100/50 border-dashed text-center">
              <p className="text-[9px] sm:text-[10px] font-black text-blue-400 uppercase tracking-widest mb-3">Langkah 1: Gunakan Template</p>
              <Button 
            variant="outline" 
          ...
          >
            ...
            <div className="flex flex-col-reverse sm:flex-row gap-3 sm:gap-4 mt-8">
              ...
              <button type="submit" className="w-full sm:flex-[2] bg-blue-600 hover:bg-blue-700 text-white rounded-xl sm:rounded-2xl h-12 sm:h-14 font-black shadow-lg shadow-blue-200 transition-all active:scale-95 flex items-center justify-center disabled:opacity-50 disabled:active:scale-100" disabled={!xlsxFile || isSubmitting}>
