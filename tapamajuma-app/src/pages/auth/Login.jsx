...
export default function Login() {
  ...
  useEffect(() => {
        // Cek apakah browser ini adalah SEB
        const userAgent = navigator.userAgent;
        if (userAgent.match(/(SafeExamBrowser|SEB)/i)) {
            setIsSEB(true);
        }
    }, []);
              ...
              <div className="flex flex-col gap-4 mt-6">
                <div className="flex items-center">
                  ...
                  <span className="px-3 text-center text-sm text-slate-500">
                    Login dengan Media Sosial Anda
                  </span>
                  <div className="flex-grow border-t border-slate-200"></div>
                </div>
                ...
                <Button 
                  ...
                  type="button" // Tambahkan type="button" agar form tidak tersubmit tidak sengaja
                  variant="outline" 
